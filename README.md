...
Fixture-driven parity work is tracked separately from coverage-only work. See [`FixtureTests.md`](docs/FixtureTests.md) for article-driven syntax regressions and [`ParityTests.md`](docs/ParityTests.md) for the provenance-backed Wikidot evidence workflow and offline parity gate.
