...
#[path = "advanced_table_paragraphs.rs"]
mod advanced_table_paragraphs;
...
#[path = "coverage_trace_fixture_paths.rs"]
mod coverage_trace_fixture_paths;
...
#[path = "scp9506_wikidot_syntax.rs"]
mod scp9506_wikidot_syntax;
...
#[path = "wikidot_bibliography.rs"]
mod wikidot_bibliography;
